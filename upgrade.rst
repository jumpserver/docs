...
.. code-block:: shell
    ...
    $ wget https://github.com/jumpserver/koko/releases/download/1.5.2/koko-master-d860866-linux-amd64.tar.gz

    # 如果网络有问题导致下载无法完成可以使用下面地址
    $ wget https://demo.jumpserver.org/download/koko/1.5.2/koko-master-d860866-linux-amd64.tar.gz
