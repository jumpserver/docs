...
!!! tip ""
    ```sh
    cd /opt && \
    wget -O docker-guacamole-v2.4.3.tar.gz https://github.com/jumpserver/docker-guacamole/archive/master.tar.gz
    ```

!!! tip ""
    ```sh
    mkdir /opt/docker-guacamole && \
    tar -xf docker-guacamole-v2.4.3.tar.gz -C /opt/docker-guacamole --strip-components 1 && \
    rm -rf /opt/docker-guacamole-v2.4.3.tar.gz && \
...
!!! tip ""
    ...
    wget http://download.jumpserver.org/release/v2.4.3/guacamole-client-v2.4.3.tar.gz && \
    tar -xf guacamole-client-v2.4.3.tar.gz && \
    rm -rf guacamole-client-v2.4.3.tar.gz && \
    cp guacamole-client-v2.4.3/guacamole-*.war /config/tomcat9/webapps/ROOT.war && \
    cp guacamole-client-v2.4.3/guacamole-*.jar /config/guacamole/extensions/ && \
...
!!! tip ""
    ```sh
    cd /opt
    wget https://github.com/jumpserver/lina/releases/download/v2.4.3/lina-v2.4.3.tar.gz
    ```
