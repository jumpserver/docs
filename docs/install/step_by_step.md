...
!!! tip ""
    ```sh
    cd /opt && \
    wget https://github.com/jumpserver/jumpserver/releases/download/v2.5.1/jumpserver-v2.5.1.tar.gz
    ```

!!! tip ""
    ```sh
    tar xf jumpserver-v2.5.1.tar.gz
    mv jumpserver-v2.5.1 jumpserver
    ```
...
!!! tip ""
    ```sh
    cd /opt && \
    wget https://github.com/jumpserver/koko/releases/download/v2.5.1/koko-v2.5.1-linux-amd64.tar.gz
    ```

!!! tip ""
    ```sh                               
    tar -xf koko-v2.5.1-linux-amd64.tar.gz && \
    mv koko-v2.5.1-linux-amd64 koko && \
...
!!! tip ""
    ```sh
    cd /opt && \
    wget -O docker-guacamole-v2.5.1.tar.gz https://github.com/jumpserver/docker-guacamole/archive/master.tar.gz
    ```

!!! tip ""
    ```sh
    mkdir /opt/docker-guacamole && \
    tar -xf docker-guacamole-v2.5.1.tar.gz -C /opt/docker-guacamole --strip-components 1 && \
    rm -rf /opt/docker-guacamole-v2.5.1.tar.gz && \
...
!!! tip ""
    ...
    wget http://download.jumpserver.org/release/v2.5.1/guacamole-client-v2.5.1.tar.gz && \
    tar -xf guacamole-client-v2.5.1.tar.gz && \
    rm -rf guacamole-client-v2.5.1.tar.gz && \
...
!!! tip ""
    ```sh
    cd /opt
    wget https://github.com/jumpserver/lina/releases/download/v2.5.1/lina-v2.5.1.tar.gz
    ```

!!! tip ""
    ```sh
    tar -xf lina-v2.5.1.tar.gz
    mv lina-v2.5.1 lina
...
!!! tip ""
    ```sh
    cd /opt
    wget https://github.com/jumpserver/luna/releases/download/v2.5.1/luna-v2.5.1.tar.gz
    ```

!!! tip ""
    ```sh
    tar -xf luna-v2.5.1.tar.gz
    mv luna-v2.5.1 luna
