...
!!! tip ""
    ...
    docker rmi jumpserver/jms_koko:v2.3.2
    docker rmi jumpserver/jms_guacamole:v2.3.2
...
!!! tip "docker-compose 部署卸载"
    ...
    docker-compose down
    docker volume prune
    docker rmi jumpserver/jms_core:v2.3.2
    docker rmi jumpserver/jms_koko:v2.3.2
    docker rmi jumpserver/jms_guacamole:v2.3.2
    docker rmi jumpserver/jms_nginx:v2.3.2
    docker rmi jumpserver/jms_redis:v2.3.2
    docker rmi jumpserver/jms_mysql:v2.3.2
