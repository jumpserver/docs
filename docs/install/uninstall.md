...
docker rmi jumpserver/jms_koko:2.0.2
docker rmi jumpserver/jms_guacamole:2.0.2
...
docker-compose down
docker volume prune
docker rmi jumpserver/jms_core:2.0.2
docker rmi jumpserver/jms_koko:2.0.2
docker rmi jumpserver/jms_guacamole:2.0.2
docker rmi jumpserver/jms_nginx:2.0.2
docker rmi jumpserver/jms_redis:2.0.2
docker rmi jumpserver/jms_mysql:2.0.2
