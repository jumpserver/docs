...
!!! tip ""
    ...
    docker rmi jumpserver/jms_koko:v2.5.2
    docker rmi jumpserver/jms_guacamole:v2.5.2
...
!!! tip "docker-compose 部署卸载"
    ...
    docker-compose down
    docker volume prune
    docker rmi jumpserver/jms_core:v2.5.2
    docker rmi jumpserver/jms_koko:v2.5.2
    docker rmi jumpserver/jms_guacamole:v2.5.2
    docker rmi jumpserver/jms_nginx:v2.5.2
    docker rmi jumpserver/jms_redis:v2.5.2
    docker rmi jumpserver/jms_mysql:v2.5.2
