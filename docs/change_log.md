...
2026年7月29日
!!! summary "功能优化 🚀"
    - perf: Razor 组件升级到 FreeRDP 3【企业版】

!!! success "问题修复 🐛"
    - fix: 修复 fastjson 漏洞（Chen 组件）
    - fix: 修复 Okta 集成时 SAML2 认证失败的问题【企业版】
    - fix: 修复账户备份发送到邮箱失败时，任务状态仍显示成功的问题【企业版】
    - fix: 修复认证服务未正确进行证书校验的问题
    - fix: 修复敏感信息解密为空字符串时偶尔出现乱码的问题
...
2025年8月28日
!!! summary "功能优化 🚀"
    - perf: 新增 Lion 连接 Windows 资产时支持会话分享
    - perf: 新增用户过期时间与授权过期时间配置项
    - perf: 优化授权规则过期校验，仅针对激活状态规则
    - perf: 优化端点规则匹配，支持资产地址域名
    - perf: 优化 Ansible 任务支持超时设置，避免任务阻塞
    - perf: 优化 Chen 连接数据库时的停止运行快捷键
    - perf: 优化 SSO 用户登录时支持校验 MFA

!!! success "问题修复 🐛"
    - fix: fix: 修复 PostgreSQL 数据库下更新会话失败的问题
    - fix: 修复离线播放器无法播放下载录像的问题
    - fix: 修复 Chen 连接数据库时界面滚动条无法拖动的问题
    - fix: 修复修复系统设置中登录限制对第三方用户未生效的问题
    - fix: 修复收集资产信息时不显示 CPU 型号问题
    - fix: 修复节点、资产、用户 Suggestion 接口跨组织显示的问题【企业版】
    - fix: 修复 Magnus 一些特定情况下出现 Panic 的问题【企业版】
    - fix: 修复 Magnus 无法预览 Oracle 数据库 CLOB 字段的问题【企业版】
    - fix: 修复MySQL 改密会导致账号其他数据库权限被覆盖的问题【企业版】
    - fix: 修复 PostgreSQL、MongoDB 改密结果总是成功的问题 【企业版】
    - fix: 修复工单处于一级审批时，二级审批人也可以查看的问题 【企业版】
    - fix: 修复 Chen 连接 Oracle 数据库时 DISTINCT 关键字无法使用的问题【企业版】
    - fix: 修复 Chen 连接某些 PostgreSQL 数据库时的字段序列化问题【企业版】
...
2025年1月2日
!!! summary "功能优化 🚀"
    - perf: 优化全局组织可以查看资源的活动日志【企业版】
    - perf: 优化创建账号增加活动日志
    - perf: 优化 OAuth 2.0 认证使用标准协议传递认证信息【企业版】
    - perf: 优化更新会话命令数量时，不记录为操作日志
    - perf: 优化关闭作业中心-批量命令执行功能后，工作台-文件上传功能还可以正常使用
    - perf: 优化企业版 License 过期后，虚拟应用和远程应用的企业版连接方式不可用【企业版】
    - perf: 优化申请资产工单详情页面增加组织 ID 显示【企业版】
    - perf: 优化资源详情中 comment 字段换行显示问题
    - perf: 优化支持 Oracle 连接的 ZHS32GB18030 字符集（Magnus）【企业版】

!!! success "问题修复 🐛"
    - fix: 修复开启 OIDC 认证后，启用 USE_STATE 会导致本地用户登录失败的问题【企业版】
    - fix: 修复 REDIS_PASSWORD 配置项进行加密后，服务启动失败的问题
    - fix: 修复 Prometheus API 返回的数据类型不正确导致监控服务显示报错的问题
    - fix: 修复用户登录后偶尔会进入到系统组织的问题【企业版】
    - fix: 修复 Firfox 浏览器导出资源失败的问题
    - fix: 修复资源分页选择时的问题
    - fix: 修复客户端方式连接 Windows 资产时从挂在磁盘拖动文件到桌面时会多次记录审计日志的问题（Razor）【企业版】
...
2024年10月31日
!!! success "问题修复 🐛"
    - fix: 修复 Oracle 数据库使用本地客户端连接失败的问题（Magnus）【企业版】

v3.10.14
------------------------
2024年10月24日
!!! summary "功能优化 🚀" 
    - perf: 客户端方式连接 Windows 资产支持复制、粘贴、文件上传、下载和键盘事件等内容记录和审计【企业版】
    - perf: KoKo 增加配置项 DISABLE_INPUT_AS_COMMAND，解决输入密码时会被记录到日志中的问题（布尔类型，默认 false）
    - perf: 优化 Web SFTP 文件传输速度
    - perf: 优化快捷命令执行黑名单命令时发送告警信息

!!! success "问题修复 🐛"
    - fix: 修复当用户登录页面高并发时加载缓慢的问题
    - fix: 修复工作台仪表盘中的用户登录日志只显示登录失败记录的问题
    - fix: 修复选择用户穿梭框显示数量错误的问题
    - fix: 修复审计命令复核拒绝无法记录的问题（Magnus）【企业版】
    - fix: 修复 Magnus Oracle OOM 的问题【企业版】
...
2024年6月20日
!!! info "新增功能 🌱"
    - feat: 支持纳管 Dameng 数据库
    - feat: 支持命令存储 Elasticsearch version 8 数据库
    - feat: 支持批量测试资产可连接性

!!! summary "功能优化 🚀" 
    - perf: 优化禁用 SSH Client 的设置后，所有通过 ssh、sftp 和 telnet 协议进行的会话连接将不再显示客户端的连接方式
...
!!! success "问题修复 🐛" 
    ...
    - fix: 修复自定义平台的华为交换机执行命令失败的问题，华为交换机平台的名称中必须含 华为 或 huawei（不区分大小写） 关键字
