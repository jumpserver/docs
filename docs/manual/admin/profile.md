...
![image](../../img/V4manual_admin_profile_01.png)
## 1 个人信息
!!! tip ""
...
![image](../../img/V4manual_admin_profile_02.png)
...
- 可以使用邮箱验证码作为二次验证，管理员用户在登录时输入邮箱验证码即可完成登录。
- 在个人信息栏中开启邮箱功能
![image.png](../../img/V4manual_admin_profile_03.png)
...
- 可以使用短信验证码作为二次验证，管理员用户在登录时输入短信验证码即可完成登录。
...
![image](../../img/V4manual_admin_profile_04.png)
...
![image](../../img/V4manual_admin_profile_05.png)
...
![image](../../img/V4manual_admin_profile_06.png)
...
![image](../../img/V4manual_admin_profile_07.png)
...
![image](../../img/V4manual_admin_profile_08.png)

### 7.2 **Web终端**    
!!! tip ""
    点击个人设置页面中的中间页签 **Web终端** 按钮，对 Web 终端页面资产连接时的参数进行设置
![image](../../img/V4manual_admin_profile_09.png)    
