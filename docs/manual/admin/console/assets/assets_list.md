...
## 2 资产类型
!!! warning "注：Oracle、SQL Server、ClickHouse、Dameng、DB2、ClickHouse 数据库均为 JumpServer 企业版功能。"
!!! tip ""
...
!!! tip ""
    - Web 类型中默认包含网站。可在远程应用中自定义其他 Web 网站。Web 类型资产详细配置见 [创建Web资产](web_assets.md)。
