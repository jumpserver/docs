...
.. code-block:: shell
    ...
    $ docker run --name jms_koko -d -p 2222:2222 -p 5000:5000 -e CORE_HOST=http://<Jumpserver_url> -e BOOTSTRAP_TOKEN=xxxxxx -e LOG_LEVEL=ERROR jumpserver/jms_koko:1.5.0
